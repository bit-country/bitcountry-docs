...
`)),
            React.createElement("div", { className: styles.baseUrlSuggestionWarning, style: {
                ...
                React.createElement("p", null,
                    ...
                    ' ',
                    React.createElement("span", { style: { fontWeight: 'bold', color: 'green' }, id: BaseUrlSuggestionContainerId }),
                    ' '))));
    }
    return null;
}
