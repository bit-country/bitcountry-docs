...
.loadingSpinner__-packages-docusaurus-theme-search-algolia-src-theme-SearchPage- {
  ...
  border-radius: 50%;
  -webkit-animation: loadingspin__-packages-docusaurus-theme-search-algolia-src-theme-SearchPage-
    1s linear infinite;
  animation: loadingspin__-packages-docusaurus-theme-search-algolia-src-theme-SearchPage-
    1s linear infinite;
  margin: 0 auto;
}
