...
pre {
  ...
  font: 90%/1.45 SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono,
    Courier New, monospace;
...
kbd {
  ...
  font: 80% SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono,
    Courier New, monospace;
...
.breadcrumbs__item:not(:last-child):after {
  background: url('data:image/svg+xml;utf8,<svg alt="Chevron Right" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 256 256" style="enable-background:new 0 0 256 256;" xml:space="preserve"><g><g><polygon points="79.093,0 48.907,30.187 146.72,128 48.907,225.813 79.093,256 207.093,128"/></g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g></svg>')
    50%;
...
.menu__link--sublist:after {
  background: url('data:image/svg+xml;utf8,<svg alt="Arrow" xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" viewBox="0 0 24 24"><path fill="rgba(0,0,0,0.5)" d="M7.41 15.41L12 10.83l4.59 4.58L18 14l-6-6-6 6z"></path></svg>')
    50%/2rem 2rem;
...
.navbar__search-input {
  appearance: none;
  background: url('data:image/svg+xml;utf8,<svg fill="currentColor" alt="Search" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" height="16px" width="16px"><path d="M6.02945,10.20327a4.17382,4.17382,0,1,1,4.17382-4.17382A4.15609,4.15609,0,0,1,6.02945,10.20327Zm9.69195,4.2199L10.8989,9.59979A5.88021,5.88021,0,0,0,12.058,6.02856,6.00467,6.00467,0,1,0,9.59979,10.8989l4.82338,4.82338a.89729.89729,0,0,0,1.29912,0,.89749.89749,0,0,0-.00087-1.29909Z" /></svg>')
    0.75rem/1rem 1rem no-repeat #ebedf0;
...
.indexCtasGitHubButtonWrapper_3Z95,
.pagination-nav {
  display: flex;
}
...
#nprogress .spinner-icon {
  ...
  border-width: 2px;
  border-radius: 50%;
  -webkit-animation: 0.4s linear infinite a;
...
.baseUrlSuggestionWarning_1LNZ,
.collapseSidebarButton_2Rld,
.sidebarLogo_1r7B {
  display: none;
}
...
.skipToContent_3oI8:focus {
  left: 1rem;
}

.announcementBar_UUUQ {
  position: relative;
  width: 100%;
  height: auto;
...
.announcementBarCloseable_1YxS {
  margin-right: 55px;
}

.announcementBarContent_Op4M a {
  color: inherit;
  text-decoration: underline;
}
...
.copyButton_JoxW:focus,
.footerLogoLink_3q8c:hover,
:hover > .hash-link {
  opacity: 1;
}
...
.searchQueryInput_1lQ5,
.searchVersionInput_17i5 {
  border-radius: var(--ifm-global-radius);
...
.algoliaLogoPathFill_1KiU {
  fill: var(--ifm-font-color-base);
}

.searchResultItem_1dDF {
  padding: 1rem 0;
  border-bottom: 1px solid #dfe3e8;
}

.searchResultItemHeading_G863 {
  font-size: var(--ifm-h2-font-size);
}

.searchResultItemPath_29D1 {
  font-size: 0.8rem;
  color: var(--ifm-color-content-secondary);
  display: block;
}

.searchResultItemSummary_2tei {
  margin: 0.5rem 0 0;
  font-style: italic;
}
...
.loadingSpinner_2A3R {
  ...
  border-radius: 50%;
  -webkit-animation: 1s linear infinite b;
...
.announcementDark_mjZd {
  background-color: #20232a;
  color: #fff;
}

.announcementInner_363r {
  margin: 0 auto;
  max-width: 768px;
}
...
.heroProjectTagline_2nZ2 {
  color: #fff;
  font-size: 60px;
  margin: 0;
}

.heroProjectKeywords_3qN3,
.sidebarItemLinkActive_1fZt,
.sidebarItemLink_2ZaB:hover {
  color: var(--ifm-color-primary);
}
...
.indexCtasGetStartedButton_2SOA {
  border-width: 1px;
  display: inline-block;
  line-height: 1.2em;
...
.playgroundEditorHeader_OKzS {
  background: var(--ifm-color-emphasis-600);
  color: var(--ifm-color-content-inverse);
}

.playgroundPreviewHeader_173s {
  background: var(--ifm-color-emphasis-200);
  color: var(--ifm-color-content);
}

.playgroundEditor_8cG6 {
...
.codeBlockContent_2Pnf:hover > .copyButton_JoxW,
.codeBlockTitle_2qqm:hover + .codeBlockContent_2Pnf .copyButton_JoxW {
  outline: 0;
  opacity: 1;
}
...
.mdxCodeBlock_1dyV pre {
  font-size: inherit;
}

.feedbackBackground_2r3w {
...
.sidebar_3hfE::-webkit-scrollbar {
  width: 7px;
}

.sidebar_3hfE::-webkit-scrollbar-track {
  background: #f1f1f1;
  border-radius: 10px;
}

.sidebar_3hfE::-webkit-scrollbar-thumb {
  background: #888;
  border-radius: 10px;
}

.sidebar_3hfE::-webkit-scrollbar-thumb:hover {
  background: #555;
}

.sidebarItemTitle_1n1m {
  margin-bottom: 0.5rem;
}

.sidebarItemList_3Sjq {
  overflow-y: auto;
  font-size: 0.9rem;
  padding-left: 0;
}
...
.sidebarItemLink_2ZaB {
  color: var(--ifm-font-color-base);
}

.tableOfContents_1BMJ::-webkit-scrollbar {
  width: 7px;
}

.tableOfContents_1BMJ::-webkit-scrollbar-track {
  background: #f1f1f1;
  border-radius: 10px;
}

.tableOfContents_1BMJ::-webkit-scrollbar-thumb {
  background: #888;
  border-radius: 10px;
}

.tableOfContents_1BMJ::-webkit-scrollbar-thumb:hover {
  background: #555;
}
...
.docItemContainer_2szM {
  margin: 0 auto;
  padding: 0 0.5rem;
}

.docLastUpdatedAt_2Ta0 {
  font-weight: 700;
}
...
.DocSearch-Reset {
  -webkit-animation: 0.1s ease-in forwards d;
...
@media (min-width: 997px) {
  ...
  .sidebarWithHideableNavbar_mXRE {
    padding-top: 0;
  }
  ...
  .menu_Okmt::-webkit-scrollbar {
    width: 7px;
  }

  .menu_Okmt::-webkit-scrollbar-track {
    background: #f1f1f1;
    border-radius: 10px;
  }

  .menu_Okmt::-webkit-scrollbar-thumb {
    background: #888;
    border-radius: 10px;
  }

  .menu_Okmt::-webkit-scrollbar-thumb:hover {
    background: #555;
  }
  ...
  .menuLinkText_2H0D:hover {
    background: none;
  }

  .menuWithAnnouncementBar_30sZ {
  ...
  html[data-theme='dark'] .collapseSidebarButton_2Rld {
  ...
  .collapsedDocSidebar_2r0X:focus,
  .collapsedDocSidebar_2r0X:hover,
  html[data-theme='dark'] .collapseSidebarButton_2Rld:focus,
  html[data-theme='dark'] .collapseSidebarButton_2Rld:hover {
  ...
  .docSidebarContainerHidden_3vkb {
    width: 30px;
    cursor: e-resize;
  }

  .collapsedDocSidebar_2r0X {
    position: -webkit-sticky;
    position: sticky;
    top: 0;
    height: 100%;
  ...
  html[data-theme='dark'] .collapsedDocSidebar_2r0X:focus,
  html[data-theme='dark'] .collapsedDocSidebar_2r0X:hover {
    background-color: var(--collapse-button-bg-color-dark);
  }

  .collapsedDocSidebar_2r0X:before {
    content: '';
  ...
  .docMainContainer_2pgU {
    flex-grow: 1;
  }

  .docItemWrapperEnhanced_15Uu {
...
@media screen and (max-width: 997px) {
  .displayOnlyInLargeViewport_2rf5 {
...
@media only screen and (max-width: 996px) {
  .searchQueryColumn_1usN,
  .searchResultsColumn_5muo {
    max-width: 60% !important;
  }

  .searchLogoColumn_BhNM,
  .searchVersionColumn_1OnB {
